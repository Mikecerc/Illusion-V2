...
export default {
    ...
    async execute(interaction: any) {
        if (interaction.options.getString("type") == "true") {
            ...
            const row1 = new MessageActionRow<ModalActionRowComponent>().addComponents(question);
            const row2 = new MessageActionRow<ModalActionRowComponent>().addComponents(answer1);
            const row3 = new MessageActionRow<ModalActionRowComponent>().addComponents(answer2);
            const row4 = new MessageActionRow<ModalActionRowComponent>().addComponents(answer3);
            const row5 = new MessageActionRow<ModalActionRowComponent>().addComponents(answer4);
            ...
            const row = new MessageActionRow<ModalActionRowComponent>().addComponents(question);
